/**
 * @file test11.cpp
 * @brief Exercises exec calls and privilege changes.
 */
...
/**
 * @brief Entry point for exec and privilege tests.
 */
main() {
    int i;
