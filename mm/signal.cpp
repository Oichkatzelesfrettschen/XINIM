 ...
 * events generated by system calls or hardware
 * sources. This module evaluates pending signals,
 ...
 * - ::do_ksig()    -- handle
 * signals originating in the kernel
 * - ::sig_proc()   -- interrupt or terminate a signalled
 * process
 * - ::do_alarm()   -- set or cancel interval timers
 * - ::set_alarm()  -- helper used
 * by ::do_alarm()
...
PUBLIC int do_alarm() noexcept {
    ...
    return static_cast<int>(
        sec); // Original returned r (which was remaining time from set_alarm)
