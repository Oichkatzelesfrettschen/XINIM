...
inline constexpr int BYTE = 0377;   // mask for 8 bits
...
inline constexpr char *NIL_PTR = nullptr; // generally useful null pointer

inline constexpr int NO_NUM = 0x8000;         // used as numerical argument to panic
inline constexpr int MAX_PATH = 128;          // max length of path names
