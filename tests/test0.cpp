...
/**
 * @file test0.cpp
 * @brief Regression tests for basic file system operations.
 */
extern int errno;
int errct;
int testnr;
...
/**
 * @brief Entry point for the file system regression test.
 */
int main(void) {
    int i;
    char let;
...
static void test00(void) {
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (read(n, aa, 4) != 4)
            e(19);
        if (aa[0] != 0 || aa[1] != 1 || aa[2] != 2 || aa[3] != 3)
            e(20);
        if (lseek(n, 0L, 0) != 0L)
            e(21);
        if (lseek(n, 2L, 1) != 2L)
        ...
        if (read(n, aa, 4) != 2)
            e(23);
        if (aa[0] != 2 || aa[1] != 3 || aa[2] != 2 || aa[3] != 3)
            e(24);
        if (lseek(n, 2L, 0) != 2L)
            e(25);
        clraa();
        ...
        if (read(n, aa, 10) != 6)
            e(28);
        if (aa[0] != 0 || aa[1] != 1 || aa[2] != 10 || aa[3] != 20)
            e(29);
        if (lseek(n, 16L, 0) != 16L)
            e(30);
        if (lseek(n, 2040L, 2) != 2046L)
            e(31);
        if (read(n, aa, 10) != 0)
            e(32);
        if (lseek(n, 0L, 1) != 2046L)
            e(33);
        clraa();
        if (write(n, c, 4) != 4)
            e(34);
        if (lseek(n, 0L, 1) != 2050L)
            e(35);
        if (lseek(n, 2040L, 0) != 2040L)
            e(36);
        clraa();
        if (read(n, aa, 20) != 10)
            e(37);
        if (aa[0] != 0 || aa[5] != 0 || aa[6] != 10 || aa[9] != 40)
            e(38);
        if (lseek(n, 10239L, 0) != 10239L)
            e(39);
        if (write(n, d, 2) != 2)
            e(40);
        if (lseek(n, -2L, 2) != 10239L)
            e(41);
        if (read(n, aa, 2) != 2)
            e(42);
        if (aa[0] != 6 || aa[1] != 7)
            e(43);
        if (lseek(n, NB * 1024L - 2L, 0) != NB * 1024L - 2L)
            e(44);
        if (write(n, b, 4) != 4)
            e(45);
        if (lseek(n, 0L, 0) != 0L)
            e(46);
        if (lseek(n, -6L, 2) != 1024L * NB - 4)
            e(47);
        clraa();
        if (read(n, aa, 100) != 6)
            e(48);
        if (aa[0] != 0 || aa[1] != 0 || aa[3] != 1 || aa[4] != 2 || aa[5] != 3)
            e(49);
        if (lseek(n, 20000L, 0) != 20000L)
            e(50);
        if (write(n, c, 4) != 4)
            e(51);
        if (lseek(n, -4L, 1) != 20000L)
            e(52);
        if (read(n, aa, 4) != 4)
            e(53);
        if (aa[0] != 10 || aa[1] != 20 || aa[2] != 30 || aa[3] != 40)
            e(54);
        if (close(n) != 0)
            e(55);
        if ((n1 = creat("foop", 0777)) != 3)
            e(56);
        if (close(n1) != 0)
            e(57);
        unlink("foop");
...
static void test01(void) {
    ...
    for (i = 0; i < 2; i++) {
        ...
        if ((n = creat("T3", 0702)) < 0)
            e(1);
        if (link("T3", "newT3") < 0)
            e(2);
        if ((n1 = open("newT3", 2)) < 0)
            e(3);
        for (j = 0; j < 255; j++)
            a[j] = j;
        if (write(n, a, 255) != 255)
            e(4);
        if (read(n1, b, 255) != 255)
            e(5);
        flag = 0;
        for (j = 0; j < 255; j++)
            if (a[j] != b[j])
        ...
        if (fstat(n1, &s1) < 0)
            e(17);
        if (s.st_dev != s1.st_dev)
            e(18);
        if (s.st_ino != s1.st_ino)
            e(19);
        if (s.st_mode != s1.st_mode)
            e(20);
        if (s.st_nlink != s1.st_nlink)
            e(21);
        if (s.st_uid != s1.st_uid)
            e(22);
        if (s.st_gid != s1.st_gid)
            e(23);
        if (s.st_rdev != s1.st_rdev)
            e(24);
        if (s.st_size != s1.st_size)
            e(25);
        if (s.st_atime != s1.st_atime)
            e(26);
        if (close(n1) < 0)
            e(27);
        if (unlink("newT3") < 0)
        ...
        umask(040);
        if ((n = creat("T3a", 0777)) < 0)
            e(29);
        if (stat("T3a", &s) < 0)
            e(30);
        if (s.st_mode != 0100737)
            e(31);
        if (unlink("T3a") < 0)
            e(32);
        if (close(n1) < 0)
