...
Warning: this file is historical and not authoritative for the active tree.
The 97.22% compliance claim recorded below is contradicted by the current
claims audit and build graph. Treat it as an obsolete report snapshot, not as
present evidence. See `docs/analysis/CLAIMS_AUDIT.md` and
`docs/POSIX_COMPLIANCE.md` for current status.

### Executive Summary
Historical claim from 2025: XINIM was described here as having achieved
**97.22% POSIX compliance** (35/36 tests passed). That claim is obsolete and is
not accepted as current fact for the active tree. The active evidence-backed
status is tracked in `docs/analysis/CLAIMS_AUDIT.md`.
...
- POSIX.1-2024 specification (HTML)
- POSIX.1-2008 specification (HTML)
