...
constexpr char kUsage[] = "usage: seekpatch PATH OFFSET TEXT\r\n";
constexpr char kOpenFail[] = "seekpatch: open failed\r\n";
constexpr char kSeekFail[] = "seekpatch: lseek failed\r\n";
constexpr char kWriteFail[] = "seekpatch: write failed\r\n";
