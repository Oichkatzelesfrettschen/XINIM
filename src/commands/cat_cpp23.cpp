...
namespace {
    ...
    [[nodiscard]] Result<void> process_stream(std::istream &input, const Options &opts,
                                              size_t &line_number) {
        std::string line;
    ...
    [[nodiscard]] Result<void> process_file(std::string_view filename, const Options &opts,
                                            size_t &line_number) {
        if (filename == "-") {
            // Read from stdin
