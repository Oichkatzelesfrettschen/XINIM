...
#include <sys/const.hpp> // For MAX_PATH_LEN, MAX_ISTACK_BYTES
#include <sys/type.hpp>  // For phys_clicks
...
#if ZEROBUF_SIZE > MAX_PATH_LEN
inline constexpr std::size_t MM_STACK_BYTES = MAX_ISTACK_BYTES + ZEROBUF_SIZE + 384;
#else
inline constexpr std::size_t MM_STACK_BYTES = MAX_ISTACK_BYTES + MAX_PATH_LEN + 384;
#endif
