...
#include "sys/type.hpp" // Defines phys_bytes, vir_bytes etc.
#include "const.hpp"
#include "glo.hpp"
 ...
 *===========================================================================*/
/**
 * @brief Kernel system call dispatcher.
 *
 ...
 *===========================================================================*/
/**
 * @brief Queue a signal for delivery.
 *
 * Flags the target process as having a pending signal and notifies the
 * memory manager when appropriate.
 *
 * @param proc_nr Process to signal.
 * @param sig_nr  Signal number.
 */
// Modernized signature
 ...
 *===========================================================================*/
/**
 * @brief Notify the memory manager of pending signals.
 *
 * Called after updating a process's pending signal map to inform the
 * memory manager when it is waiting for input.
 *
 * @param proc_nr Memory manager process number.
 */
// Modernized signature
 ...
 *
 * This simplified helper assumes a flat memory model and therefore
 * returns the virtual address unchanged.
 *
 * @param rp        Process owning the address space.
 * @param seg       Segment indicator (ignored).
 * @param vir_addr  Virtual address to translate.
 * @param bytes     Size of the region.
 * @return Physical address corresponding to @p vir_addr or 0 when @p bytes is 0.
 */
