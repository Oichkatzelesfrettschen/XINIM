/**
 * @file scheduler.hpp
 * @brief Runnable-process selection and initial context handoff interface
 *
 * @ingroup kernel
 */
...
namespace xinim::kernel {
    ...
    /**
     * @brief Update legacy runnable-process selection from the timer callback.
     *
     * This function does not save the interrupted x86_64 frame or transfer to a
     * different CPU context.
     */
    void schedule();
