...
namespace xinim::kernel {
     ...
     * Bits 3-15: Index = 1
     */
    constexpr uint16_t KERNEL_CS = XINIM_X86_KERNEL_CS_SELECTOR;
     ...
     * Bits 3-15: Index = 2
     */
    constexpr uint16_t KERNEL_DS = XINIM_X86_KERNEL_DS_SELECTOR;
     ...
     * Bits 3-15: Index = 3
     */
    constexpr uint16_t USER_CS = XINIM_X86_USER_CS_SELECTOR;
     ...
     * Bits 3-15: Index = 4
     */
    constexpr uint16_t USER_DS = XINIM_X86_USER_DS_SELECTOR;
     ...
     * Bits 3-15: Index = 5
     */
    constexpr uint16_t TSS_SEL = XINIM_X86_TSS_SELECTOR;
     ...
     */
    constexpr uint16_t get_kernel_cs() {
        return KERNEL_CS;
    }
     ...
     */
    constexpr uint16_t get_kernel_ds() {
        return KERNEL_DS;
    }
     ...
     */
    constexpr uint16_t get_user_cs() {
        return USER_CS;
    }
     ...
     */
    constexpr uint16_t get_user_ds() {
        return USER_DS;
    }
