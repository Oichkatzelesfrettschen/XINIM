...
namespace xinim::i486::ring3 {
    ...
    constexpr uint16_t kKernelCodeSelector = XINIM_X86_KERNEL_CS_SELECTOR;
    constexpr uint16_t kKernelDataSelector = XINIM_X86_KERNEL_DS_SELECTOR;
    constexpr uint16_t kUserCodeSelector = XINIM_X86_USER_CS_SELECTOR;
    constexpr uint16_t kUserDataSelector = XINIM_X86_USER_DS_SELECTOR;
    constexpr uint16_t kTssSelector = XINIM_X86_TSS_SELECTOR;
    constexpr uint8_t kTimerVector = 32U;
    constexpr uint8_t kSyscallVector = 0x80U;
    constexpr uint32_t kKernelStackSize = 32768U;
    ...
    constexpr uint32_t kMaxUserMappings = 256U;
    constexpr int kFcntlDupFd = 0;
    constexpr int kFcntlGetFd = 1;
    constexpr int kFcntlSetFd = 2;
    constexpr int kFcntlGetFl = 3;
    constexpr int kFcntlSetFl = 4;
    constexpr int kFcntlGetLk = 5;
    constexpr int kFcntlSetLk = 6;
    constexpr int kFcntlSetLkW = 7;
    ...
    static_assert(offsetof(RegisterFrame, eax) == XINIM_X86_32_REGISTER_EAX);
    static_assert(offsetof(RegisterFrame, ebx) == XINIM_X86_32_REGISTER_EBX);
    static_assert(offsetof(RegisterFrame, ecx) == XINIM_X86_32_REGISTER_ECX);
    static_assert(offsetof(RegisterFrame, edx) == XINIM_X86_32_REGISTER_EDX);
    static_assert(offsetof(RegisterFrame, esi) == XINIM_X86_32_REGISTER_ESI);
    static_assert(offsetof(RegisterFrame, edi) == XINIM_X86_32_REGISTER_EDI);
    static_assert(offsetof(RegisterFrame, ebp) == XINIM_X86_32_REGISTER_EBP);
    static_assert(offsetof(RegisterFrame, ds) == XINIM_X86_32_REGISTER_DS);
    static_assert(offsetof(RegisterFrame, es) == XINIM_X86_32_REGISTER_ES);
    static_assert(offsetof(RegisterFrame, fs) == XINIM_X86_32_REGISTER_FS);
    static_assert(offsetof(RegisterFrame, gs) == XINIM_X86_32_REGISTER_GS);
    static_assert(sizeof(RegisterFrame) == XINIM_X86_32_REGISTER_SIZE);

    static_assert(offsetof(UserContext, eax) == XINIM_X86_32_USER_EAX);
    static_assert(offsetof(UserContext, ebx) == XINIM_X86_32_USER_EBX);
    static_assert(offsetof(UserContext, ecx) == XINIM_X86_32_USER_ECX);
    static_assert(offsetof(UserContext, edx) == XINIM_X86_32_USER_EDX);
    static_assert(offsetof(UserContext, esi) == XINIM_X86_32_USER_ESI);
    static_assert(offsetof(UserContext, edi) == XINIM_X86_32_USER_EDI);
    static_assert(offsetof(UserContext, ebp) == XINIM_X86_32_USER_EBP);
    static_assert(offsetof(UserContext, ds) == XINIM_X86_32_USER_DS);
    static_assert(offsetof(UserContext, es) == XINIM_X86_32_USER_ES);
    static_assert(offsetof(UserContext, fs) == XINIM_X86_32_USER_FS);
    static_assert(offsetof(UserContext, gs) == XINIM_X86_32_USER_GS);
    static_assert(offsetof(UserContext, eip) == XINIM_X86_32_USER_EIP);
    static_assert(offsetof(UserContext, cs) == XINIM_X86_32_USER_CS);
    static_assert(offsetof(UserContext, eflags) == XINIM_X86_32_USER_EFLAGS);
    static_assert(offsetof(UserContext, esp) == XINIM_X86_32_USER_ESP);
    static_assert(offsetof(UserContext, ss) == XINIM_X86_32_USER_SS);
    static_assert(sizeof(UserContext) == XINIM_X86_32_USER_SIZE);
    ...
    template <uint32_t Count> struct ExecVector {
        uint32_t count;
    ...
    [[nodiscard]] SupervisedService *
    find_supervised_service_by_process(const Process *process) noexcept;
