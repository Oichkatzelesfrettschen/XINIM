...
namespace xinim::userland::x86_64 {
    ...
    inline uint64_t syscall3(uint64_t number, uint64_t arg0, uint64_t arg1,
    ...
    inline uint64_t syscall4(uint64_t number, uint64_t arg0, uint64_t arg1, uint64_t arg2,
    ...
    inline uint64_t syscall5(uint64_t number, uint64_t arg0, uint64_t arg1, uint64_t arg2,
                             uint64_t arg3, uint64_t arg4) noexcept {
        register uint64_t r10 __asm__("r10") = arg3;
    ...
    inline uint64_t syscall6(uint64_t number, uint64_t arg0, uint64_t arg1, uint64_t arg2,
                             uint64_t arg3, uint64_t arg4, uint64_t arg5) noexcept {
        register uint64_t r10 __asm__("r10") = arg3;
        register uint64_t r8 __asm__("r8") = arg4;
    ...
    inline uint64_t read(uint64_t fd, void *buffer, uint64_t count) noexcept {
        return syscall3(static_cast<uint64_t>(SYS_read), fd, reinterpret_cast<uint64_t>(buffer),
                        count);
    }

    inline uint64_t write(uint64_t fd, const void *buffer, uint64_t count) noexcept {
        return syscall3(static_cast<uint64_t>(SYS_write), fd, reinterpret_cast<uint64_t>(buffer),
                        count);
    }
    ...
    inline uint64_t open(const char *pathname, uint64_t flags, uint64_t mode) noexcept {
        return syscall3(static_cast<uint64_t>(SYS_open), reinterpret_cast<uint64_t>(pathname),
                        flags, mode);
    }
    ...
    inline uint64_t dup(int old_fd) noexcept {
        return syscall1(static_cast<uint64_t>(SYS_dup), static_cast<uint64_t>(old_fd));
    }

    inline uint64_t dup2(int old_fd, int new_fd) noexcept {
        return syscall2(static_cast<uint64_t>(SYS_dup2), static_cast<uint64_t>(old_fd),
                        static_cast<uint64_t>(new_fd));
    }

    inline uint64_t pipe(int descriptors[2]) noexcept {
        return syscall1(static_cast<uint64_t>(SYS_pipe), reinterpret_cast<uint64_t>(descriptors));
    }

    inline uint64_t access(const char *path, int mode) noexcept {
        return syscall2(static_cast<uint64_t>(SYS_access), reinterpret_cast<uint64_t>(path),
    ...
    inline uint64_t getcwd(char *buffer, uint64_t size) noexcept {
        return syscall2(static_cast<uint64_t>(SYS_getcwd), reinterpret_cast<uint64_t>(buffer),
                        size);
    }
    ...
    inline uint64_t execve(const char *path, char *const *argv, char *const *envp) noexcept {
        return syscall3(static_cast<uint64_t>(SYS_execve), reinterpret_cast<uint64_t>(path),
    ...
    inline uint64_t wait4(int pid, int *status, int options, void *rusage) noexcept {
        return syscall4(static_cast<uint64_t>(SYS_wait4), static_cast<uint64_t>(pid),
                        reinterpret_cast<uint64_t>(status), static_cast<uint64_t>(options),
                        reinterpret_cast<uint64_t>(rusage));
    }

    inline uint64_t lseek(int fd, int64_t offset, int whence) noexcept {
        return syscall3(static_cast<uint64_t>(SYS_lseek), static_cast<uint64_t>(fd),
                        static_cast<uint64_t>(offset), static_cast<uint64_t>(whence));
    }
